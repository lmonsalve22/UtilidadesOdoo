...
{
    public class GraficoDeprecated
    {
        ...
        public GraficoDeprecated(int iD, string nOMBRE, string tITULO, string sUBTITULO, string dESCRIPCION, string fECHA_PUBLICACION, string rEGION, string pERIODO_ESTUDIO, string gRUPO_EDAD, string tAGS, string mACROTEMA, string uRL, string Español)
        {
            ID = iD;
            NOMBRE = nOMBRE;
            TITULO = tITULO;
