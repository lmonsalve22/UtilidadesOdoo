...
namespace AplicacionBlanco.Models
{
    public class Graficos
    {
        ...
        public Graficos()
        {
            ...
            GRAFICOS.Add(new Grafico(6, "Grafico_Test_2", "Gráfico Test 2", "", "Este gráfico es de ejemplo para usos varios.",
                                                "3 de Marzo", "Sin región", "Sin Período", "Sin grupo de edad", "test prueba", "Prueba", "testClent.csv", "español"));
