...
namespace AplicacionBlanco.Models
{
    public class Graficos
    {
        ...
        public List<GraficoDeprecated> GRAFICOS { get; set; }

        public Graficos()
        {
            GRAFICOS = new List<GraficoDeprecated>();
            ...
            GRAFICOS.Add(new GraficoDeprecated(iD:1, 
                                    ...
                                    uRL:"test.csv",
                                    Español:"Espanol"));
            GRAFICOS.Add(new GraficoDeprecated(2, "Grafico_Test_2", "Gráfico Test 2", "", "Este gráfico es de ejemplo para usos varios.", 
                                     "3 de Marzo", "Sin región", "Sin Período", "Sin grupo de edad", "test prueba", "Prueba", "test2.csv","español"));
            GRAFICOS.Add(new GraficoDeprecated(3, "Grafico_Test_3", "Gráfico Test 3", "", "Este gráfico es de ejemplo para usos varios.",
                                     "3 de Marzo", "Sin región", "Sin Período", "Sin grupo de edad", "test prueba", "Prueba", "test3.csv", "español"));
            GRAFICOS.Add(new GraficoDeprecated(4, "Grafico_Test_2", "Gráfico Test 2", "", "Este gráfico es de ejemplo para usos varios.",
                                     "3 de Marzo", "Sin región", "Sin Período", "Sin grupo de edad", "test prueba", "Prueba", "test4.csv", "español"));
            GRAFICOS.Add(new GraficoDeprecated(5, "Grafico_Test_2", "Gráfico Test 2", "", "Este gráfico es de ejemplo para usos varios.",
                                     "3 de Marzo", "Sin región", "Sin Período", "Sin grupo de edad", "test prueba", "Prueba", "test5.csv", "español"));
            GRAFICOS.Add(new GraficoDeprecated(6, "Gráfico de geografía", "Mapa geográfico", "", "Este gráfico es de ejemplo para usos varios.",
                                     "3 de Marzo", "Sin región", "Sin Período", "Sin grupo de edad", "test prueba", "Prueba", "mapadechile_engeochart_2021.csv", "español"));


        }

        public GraficoDeprecated BuscarGrafico(int id)
        {
